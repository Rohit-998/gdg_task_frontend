...
function SectionTitle({ children }: { children: React.ReactNode }) {
  return (
    <div className="text-center">
      <h2
        className="font-medium text-[#5F5F5F] dark:text-gray-200 text-[40px] leading-[50px] tracking-[-0.022em]"
  ...
  return (
    <section id="about" className="mx-auto max-w-5xl px-6">
      <div className="flex justify-center">
        <h2
          className="font-bold text-[45px] leading-[90px] tracking-[-0.022em] text-[#5F5F5F] dark:text-gray-200 text-center pb-15"
          style={{ fontFamily: "Product Sans, sans-serif" }}
        >
          Get To Know Us!
        </h2>
