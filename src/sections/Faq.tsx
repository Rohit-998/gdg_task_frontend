...
const items = [
  {
    ...
    bar: "/redbar2.svg",
    AnsClassName:
      "flex-1  border-9 rounded-r-3xl md:rounded-r-3xl lg:py-7 lg:pl-5 lg:pr-3  md:py-1 md:pl-5 md:pr-2 pr-3 pl-3 py-3 text-sm text-gray-700 shadow-sm border-[#E1E1E1] lg:py-10 md:py-4   ",
  ...
  },
  {
    ...
    bar: "/greenbar.svg",
    AnsClassName:
      "flex-1  border-9 rounded-r-3xl md:rounded-r-3xl lg:py-5 lg:pl-5 lg:pr-3  md:py-1 md:pl-5 md:pr-2 pr-3 pl-3 py-3 text-sm text-gray-700 shadow-sm border-[#E1E1E1] lg:py-4 md:py-4 ",
...
export function Faq() {
  return (
    <section className="mx-auto max-w-3xl px-6 py-12">
      <h1 className="text-4xl text-[#5F5F5F] font-semibold text-center mb-8 font-pt-sans-700 ">FAQs</h1>
