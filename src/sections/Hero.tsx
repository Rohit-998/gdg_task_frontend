...
export function Hero() {
  return (
    <section className="relative mx-auto max-w-5xl px-6 pt-20 pb-12 text-center">
      ...
      <h2 className="text-[#646464] dark:text-gray-300 font-bold">
        RBU Chapter
      </h2>
      ...
      <motion.button
        whileHover={{ y: -2 }}
        whileTap={{ scale: 0.98 }}
        className="mt-6 inline-flex items-center justify-center rounded-md py-3 px-11 text-white shadow-sm font-open-sans-700 bg-[#3686F7]"
      >
        Join Us
      </motion.button>
